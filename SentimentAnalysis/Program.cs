    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (newStr == "0") break;
                UseModelWithSingleItem(mlContext, model, newStr);
            }
            // </SnippetCallUseModelWithSingleItem>
        ...
        private static void UseModelWithSingleItem(MLContext mlContext, ITransformer model, string currentStr)
        {
